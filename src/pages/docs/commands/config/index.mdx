...
- gitlab_uri: if unset, defaults to [https://gitlab.com](https://gitlab.com)
...
- glamour_style: Your desired markdown renderer style. Options are dark, light, notty. Custom styles are allowed set a custom style [https://github.com/charmbracelet/glamour#styles](https://github.com/charmbracelet/glamour#styles)
