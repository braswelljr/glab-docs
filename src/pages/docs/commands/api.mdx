...
GitLab REST API Docs: [https://docs.gitlab.com/ce/api/README.html](https://docs.gitlab.com/ce/api/README.html)
GitLab GraphQL Docs: [https://docs.gitlab.com/ee/api/graphql](https://docs.gitlab.com/ee/api/graphql)
