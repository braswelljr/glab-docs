const Custom404 = () => {
  return (
    ...
    >
      <h1 className="text-2xl font-extrabold tracking-tight text-neutral-900 dark:text-yellow-200 sm:mr-6 sm:border-r sm:border-neutral-900/10 sm:pr-6 sm:text-3xl sm:dark:border-yellow-300/10">
        404
      </h1>
